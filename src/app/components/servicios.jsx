      ...
      <section class="bg-gray-900 text-white">
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div class="mx-auto max-w-lg text-center">
            <h2 class="text-3xl font-bold sm:text-4xl">Servicios</h2>
          ...
          <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <h2 class="mt-4 text-xl font-bold text-white">Desarrollo Web</h2>
            ...
            >
              ...
              <h2 class="mt-4 text-xl font-bold text-white">Langin Pages</h2>
            ...
            >
              ...
              <h2 class="mt-4 text-xl font-bold text-white">Servicio</h2>
